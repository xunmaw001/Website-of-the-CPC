...
public class GemingxianbeiCollectionEntity<T> implements Serializable {
    private static final long serialVersionUID = 1L;


	public GemingxianbeiCollectionEntity() {

	}

	public GemingxianbeiCollectionEntity(T t) {
		try {
     ...
     * 类型
     */
    @TableField(value = "gemingxianbei_collection_types")
    ...
    public String toString() {
        return "GemingxianbeiCollection{" +
            "id=" + id +
            ", gemingxianbeiId=" + gemingxianbeiId +
            ", yonghuId=" + yonghuId +
            ", gemingxianbeiCollectionTypes=" + gemingxianbeiCollectionTypes +
