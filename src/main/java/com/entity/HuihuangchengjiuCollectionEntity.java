...
public class HuihuangchengjiuCollectionEntity<T> implements Serializable {
    private static final long serialVersionUID = 1L;


	public HuihuangchengjiuCollectionEntity() {

	}

	public HuihuangchengjiuCollectionEntity(T t) {
		try {
    ...
    public String toString() {
        return "HuihuangchengjiuCollection{" +
            "id=" + id +
            ", huihuangchengjiuId=" + huihuangchengjiuId +
            ", yonghuId=" + yonghuId +
            ", huihuangchengjiuCollectionTypes=" + huihuangchengjiuCollectionTypes +
