...
public class GemingxianbeiLiuyanView extends GemingxianbeiLiuyanEntity implements Serializable {
	...
	public GemingxianbeiLiuyanView() {

	}

	public GemingxianbeiLiuyanView(GemingxianbeiLiuyanEntity gemingxianbeiLiuyanEntity) {
		try {
			BeanUtils.copyProperties(this, gemingxianbeiLiuyanEntity);
