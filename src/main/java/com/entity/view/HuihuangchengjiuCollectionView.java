...
public class HuihuangchengjiuCollectionView extends HuihuangchengjiuCollectionEntity implements Serializable {
    private static final long serialVersionUID = 1L;

		/**
		* 类型的值
		*/
		private String huihuangchengjiuCollectionValue;
	...
	public HuihuangchengjiuCollectionView() {

	}

	public HuihuangchengjiuCollectionView(HuihuangchengjiuCollectionEntity huihuangchengjiuCollectionEntity) {
		try {
			BeanUtils.copyProperties(this, huihuangchengjiuCollectionEntity);
			...
			* 获取： 类型的值
			*/
			public String getHuihuangchengjiuCollectionValue() {
				return huihuangchengjiuCollectionValue;
			}
			/**
			* 设置： 类型的值
			*/
			public void setHuihuangchengjiuCollectionValue(String huihuangchengjiuCollectionValue) {
				this.huihuangchengjiuCollectionValue = huihuangchengjiuCollectionValue;
			}
