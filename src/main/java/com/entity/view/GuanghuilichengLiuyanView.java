...
public class GuanghuilichengLiuyanView extends GuanghuilichengLiuyanEntity implements Serializable {
	...
	public GuanghuilichengLiuyanView() {

	}

	public GuanghuilichengLiuyanView(GuanghuilichengLiuyanEntity guanghuilichengLiuyanEntity) {
		try {
			BeanUtils.copyProperties(this, guanghuilichengLiuyanEntity);
