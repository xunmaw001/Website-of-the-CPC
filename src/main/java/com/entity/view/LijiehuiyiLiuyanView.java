...
public class LijiehuiyiLiuyanView extends LijiehuiyiLiuyanEntity implements Serializable {
	...
	public LijiehuiyiLiuyanView() {

	}

	public LijiehuiyiLiuyanView(LijiehuiyiLiuyanEntity lijiehuiyiLiuyanEntity) {
		try {
			BeanUtils.copyProperties(this, lijiehuiyiLiuyanEntity);
