...
public class HuihuangchengjiuLiuyanEntity<T> implements Serializable {
    private static final long serialVersionUID = 1L;


	public HuihuangchengjiuLiuyanEntity() {

	}

	public HuihuangchengjiuLiuyanEntity(T t) {
		try {
    ...
    public String toString() {
        return "HuihuangchengjiuLiuyan{" +
            "id=" + id +
            ", huihuangchengjiuId=" + huihuangchengjiuId +
            ", yonghuId=" + yonghuId +
            ", huihuangchengjiuLiuyanText=" + huihuangchengjiuLiuyanText +
