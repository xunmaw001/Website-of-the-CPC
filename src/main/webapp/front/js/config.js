...
var centerMenu = [
    ...
    ,{
        name: '革命先辈收藏',
        url: '../gemingxianbeiCollection/list.html'
    }
    ,{
        name: '光辉历程收藏',
        url: '../guanghuilichengCollection/list.html'
    }
    ,{
        name: '辉煌成就收藏',
        url: '../huihuangchengjiuCollection/list.html'
    }
    ,{
        name: '历届会议收藏',
        url: '../lijiehuiyiCollection/list.html'
    }
...
var indexNav = [
    ...
    {
        name: '革命先辈',
        url: './pages/gemingxianbei/list.html'
    },
    {
        name: '光辉历程',
        url: './pages/guanghuilicheng/list.html'
    },
    {
        name: '辉煌成就',
        url: './pages/huihuangchengjiu/list.html'
    },
    {
        name: '历届会议',
        url: './pages/lijiehuiyi/list.html'
    },
    {
        name: '留言板',
...
var adminurl =  "http://localhost:8080/zhongguogongchandangwangzhan/admin/dist/index.html#/login";
